...
namespace MTS.BL.DatabaseAccess.Migrations
{
    ...
    [Migration("20200629064255_dbUpdateModel")]
    partial class dbUpdateModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MTS.DAL.Infra.Interfaces.Credit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MTS.DAL.Infra.Interfaces.EFUserAccount", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MTS.DAL.Infra.Interfaces.EFUserAccount", null)
                        .WithMany()
